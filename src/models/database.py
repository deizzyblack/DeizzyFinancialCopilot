...
class FinancialRecord(Base):
    ...
    mapping_method = Column(String(30))
    mapping_reason = Column(String(500))
    raw_period = Column(String(100))
    period_confidence = Column(Float, default=0.0)
    confidence_total = Column(Float, default=0.0)
    confidence_extraction = Column(Float, default=0.0)
    confidence_mapping = Column(Float, default=0.0)
    confidence_sanity = Column(Float, default=0.0)
    confidence_source = Column(Float, default=0.0)
    confidence_historical = Column(Float, default=0.0)
    decision = Column(String(20))
    decision_reason = Column(String(500))
    sanity_passed = Column(String(5))
    sanity_issues_json = Column(Text, default="[]")
